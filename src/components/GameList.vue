	...
	<div class="container">
		...
		<nav class="game-nav">
			<ul>
              ...
              <li>    <router-link to="/quiz" class="cd-quiz">
                        <img src="../assets/quiz.png"/>Quiz</router-link></li>
				<li>    <router-link to="/game" class="cd-roulette"><img src="../assets/casino.png"/>Roulette</router-link></li>
			</ul>
		</nav>
